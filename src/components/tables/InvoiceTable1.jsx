...
export default class InvoiceTable1 extends React.Component {
  constructor(props) {
    super(props);
  ...
  showInvoiceList() {
    axios
      .get(URL_API + `/rest/invoice/`, OPTIONS)
      .then((invoices) => {
                      ...
                      <Modal.Body padding>
                        <div className='invoice-wrapper rounded border bg-white py-5 px-3 px-md-4 px-lg-5 col-sm-12'>
                          <div className='d-flex justify-content-between'>
                            <h2 className='text-dark font-weight-medium'>
                              Invoice
                            </h2>
                          </div>
                                ...
                                <tr key={idx}>
                                  ...
                                  <td>
                                    {this.state.rows[idx].quantity *
                                      this.state.rows[idx].price}
                                  </td>
                                  <td>
                                    <button
                                      className='btn btn-outline-danger mdi mdi-close btn-sm'
