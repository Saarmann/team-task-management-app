...
export default class TaskTable1 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      taskData: [],
  ...
  showCustomerList() {
    axios
      .get(URL_API + `/rest/customer/`, OPTIONS)
      .then((customerData) => {
  ...
  saveTask() {
    ...
    axios
      .post(URL_API + `/rest/task/save`, taskData, OPTIONS)
      .then((response) => {
